export default function DescriptionComponent() {
  return (
    <div className='w-full h-full flex justify-center items-start'>
      <div className='gap-[0.7rem] flex flex-col items-center justify-center max-w-[800px]'>
        ...
        <p className='text-[1.3rem] text-left'>Unjumblr works by <b>changing the font</b> in your images to <b>OpenDyslexic</b>, making it easier toread.</p>
